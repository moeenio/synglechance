...
cp -rf "build/bin/OneShot.app" "$ONESHOT_PATH"
cp -rf "build/bin/_______.app" "$ONESHOT_PATH"
cp -rf "build/bin/Data/xScripts.rxdata" "$ONESHOT_PATH/Data/xScripts.rxdata"
